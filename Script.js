...
function UpdateAurumData(AurumData) {
    // Overview
    document.getElementById("AurumOverview_Balance").innerText = "Balance: " + PrettyPrice(AurumData.Balance, false) + " €";
    document.getElementById("AurumOverview_Equity").innerText = "Equity: " + PrettyPrice(AurumData.Equity, false) + " €";
    document.getElementById("AurumOverview_Margin").innerText = "Free Margin: " + PrettyPrice(AurumData.FreeMargin, false) + " €";
    document.getElementById("AurumOverview_Positions").innerText = "Positions: " + AurumData.Positions;
    document.getElementById("AurumOverview_Profit").innerText = "Profit: " + PrettyPrice(AurumData.Profit) + " €";
    ...
    function AddRow(Elem, Month, Profit, Trades) {
        ...
        Text2Elem.innerText = PrettyPrice(Profit);
